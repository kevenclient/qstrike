...
<div class="card mx-auto my-5" style="max-width: 550px;">
    <div class="card-body">
        <h5 class="card-title">Edit Factory</h5>
        <div class="card-text">
            <form class="d-flex flex-column gap-3" action="/factories/{{ $id }}" method="post">
                @csrf
                @method('put')
                <div>
                    <label class="form-label">Name</label>
                    <input class="form-control" name="factory_name" value="{{ old('factory_name', $factory_name) }}"/>
                ...
                <div>
                    ...
                    <input class="form-control" name="location" value="{{ old('location', $location) }}"/>
                ...
                <div>
                    ...
                    <input class="form-control" name="website" value="{{ old('website', $website) }}"/>
